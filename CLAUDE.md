...
## Project: Kanpai
A sake companion. Three flagship features: label scan, chat recommender, taste profile.
...
Issues live in GitHub Issues (`BVengerov/kanpai`). See `docs/agents/issue-tracker.md`.
