...
_Snapshot generated 2026-06-17T05:10:19.004Z (UTC). Regenerate with `pnpm progress`._
...
_Based on 11 PR(s) merged over the last 14 days (~981 LoC/day)._
...
- **Velocity** is total LoC merged in the trailing 14 days divided by the window length in days. Idle days count against velocity: `13728` LoC across `11` PR(s) ⇒ `980.6` LoC/day.
