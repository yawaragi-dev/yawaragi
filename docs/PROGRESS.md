...
_Snapshot generated 2026-08-18T05:43:42.358Z (UTC). Regenerate with `pnpm progress`._
...
- **Median:**     2026-08-25
- **Pessimistic:** 2026-09-01

_Based on 8 PR(s) merged over the last 14 days (~126 LoC/day)._
...
- **Velocity** is total LoC merged in the trailing 14 days divided by the window length in days. Idle days count against velocity: `1758` LoC across `8` PR(s) ⇒ `125.6` LoC/day.
