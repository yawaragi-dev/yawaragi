...
_Snapshot generated 2026-07-07T05:22:12.670Z (UTC). Regenerate with `pnpm progress`._
...
_Based on 10 PR(s) merged over the last 14 days (~562 LoC/day)._
...
- **Velocity** is total LoC merged in the trailing 14 days divided by the window length in days. Idle days count against velocity: `7864` LoC across `10` PR(s) ⇒ `561.7` LoC/day.
