...
_Snapshot generated 2026-07-05T15:16:41.262Z (UTC). Regenerate with `pnpm progress`._
...
- **Optimistic:** 2026-07-07
- **Median:**     2026-07-07
- **Pessimistic:** 2026-07-09

_Based on 13 PR(s) merged over the last 14 days (~517 LoC/day)._
...
- **Velocity** is total LoC merged in the trailing 14 days divided by the window length in days. Idle days count against velocity: `7238` LoC across `13` PR(s) ⇒ `517.0` LoC/day.
