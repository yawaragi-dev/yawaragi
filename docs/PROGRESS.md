...
_Snapshot generated 2026-07-14T15:42:07.263Z (UTC). Regenerate with `pnpm progress`._
...
_Based on 47 PR(s) merged over the last 14 days (~1585 LoC/day)._
...
- **Velocity** is total LoC merged in the trailing 14 days divided by the window length in days. Idle days count against velocity: `22188` LoC across `47` PR(s) ⇒ `1584.9` LoC/day.
