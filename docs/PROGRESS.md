...
_Snapshot generated 2026-08-18T06:03:00.846Z (UTC). Regenerate with `pnpm progress`._
...
_Based on 10 PR(s) merged over the last 14 days (~181 LoC/day)._
...
- **Velocity** is total LoC merged in the trailing 14 days divided by the window length in days. Idle days count against velocity: `2531` LoC across `10` PR(s) ⇒ `180.8` LoC/day.
