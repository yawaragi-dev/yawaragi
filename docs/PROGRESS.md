...
_Snapshot generated 2026-07-07T05:25:45.219Z (UTC). Regenerate with `pnpm progress`._
...
_Based on 12 PR(s) merged over the last 14 days (~578 LoC/day)._
...
- **Velocity** is total LoC merged in the trailing 14 days divided by the window length in days. Idle days count against velocity: `8093` LoC across `12` PR(s) ⇒ `578.1` LoC/day.
