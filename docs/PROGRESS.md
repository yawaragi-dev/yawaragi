...
_Snapshot generated 2026-05-31T19:03:27.374Z (UTC). Regenerate with `pnpm progress`._
...
_Based on 33 PR(s) merged over the last 14 days (~1206 LoC/day)._
...
- **Optimistic:** 2026-06-03
- **Median:**     2026-06-05
- **Pessimistic:** 2026-06-09
...
- **Velocity** is total LoC merged in the trailing 14 days divided by the window length in days. Idle days count against velocity: `16882` LoC across `33` PR(s) ⇒ `1205.9` LoC/day.
