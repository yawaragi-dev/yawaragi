...
_Snapshot generated 2026-07-16T22:04:07.385Z (UTC). Regenerate with `pnpm progress`._
...
_Based on 54 PR(s) merged over the last 14 days (~1641 LoC/day)._
...
- **Velocity** is total LoC merged in the trailing 14 days divided by the window length in days. Idle days count against velocity: `22973` LoC across `54` PR(s) ⇒ `1640.9` LoC/day.
