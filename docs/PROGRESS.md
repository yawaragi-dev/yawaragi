...
_Snapshot generated 2026-06-22T05:27:11.851Z (UTC). Regenerate with `pnpm progress`._
...
_Based on 17 PR(s) merged over the last 14 days (~1326 LoC/day)._
...
- **Velocity** is total LoC merged in the trailing 14 days divided by the window length in days. Idle days count against velocity: `18557` LoC across `17` PR(s) ⇒ `1325.5` LoC/day.
