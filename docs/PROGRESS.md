...
_Snapshot generated 2026-06-05T08:56:52.140Z (UTC). Regenerate with `pnpm progress`._
...
_Based on 44 PR(s) merged over the last 14 days (~1496 LoC/day)._
...
- **Velocity** is total LoC merged in the trailing 14 days divided by the window length in days. Idle days count against velocity: `20948` LoC across `44` PR(s) ⇒ `1496.3` LoC/day.
