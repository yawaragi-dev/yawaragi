...
_Snapshot generated 2026-09-22T19:52:40.567Z (UTC). Regenerate with `pnpm progress`._
...
_Based on 7 PR(s) merged over the last 14 days (~206 LoC/day)._
...
- **Velocity** is total LoC merged in the trailing 14 days divided by the window length in days. Idle days count against velocity: `2882` LoC across `7` PR(s) ⇒ `205.9` LoC/day.
