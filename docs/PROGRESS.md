...
_Snapshot generated 2026-06-22T05:07:52.301Z (UTC). Regenerate with `pnpm progress`._
...
| **M3** — Flagship surfaces | Phases 3–5 | 6 / 12 | 5136 / 10272 (50%) | `██████████░░░░░░░░░░` |
...
- **Optimistic:** 2026-06-23
- **Median:**     2026-06-23
- **Pessimistic:** 2026-06-24

_Based on 16 PR(s) merged over the last 14 days (~1224 LoC/day)._

### M3 — Flagship surfaces (Phases 3–5)

Label scan (vision LLM), chat recommender (AI SDK tools + MCP), taste profile + cross-beverage map.

**Issues:** 6 closed / 12 total

**Weight (LoC of merged PRs):** 5136 closed / 10272 total — 50% done

`████████████████████░░░░░░░░░░░░░░░░░░░░`

**ETA**

- **Optimistic:** 2026-06-25
- **Median:**     2026-06-27
- **Pessimistic:** 2026-07-01
...
- **Velocity** is total LoC merged in the trailing 14 days divided by the window length in days. Idle days count against velocity: `17134` LoC across `16` PR(s) ⇒ `1223.9` LoC/day.
