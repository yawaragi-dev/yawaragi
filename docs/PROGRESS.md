...
_Snapshot generated 2026-07-07T19:53:51.994Z (UTC). Regenerate with `pnpm progress`._
...
_Based on 22 PR(s) merged over the last 14 days (~865 LoC/day)._
...
- **Velocity** is total LoC merged in the trailing 14 days divided by the window length in days. Idle days count against velocity: `12107` LoC across `22` PR(s) ⇒ `864.8` LoC/day.
