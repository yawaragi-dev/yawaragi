...
_Snapshot generated 2026-07-19T20:15:28.797Z (UTC). Regenerate with `pnpm progress`._
...
- **Optimistic:** 2026-07-20
- **Median:**     2026-07-20
- **Pessimistic:** 2026-07-21

_Based on 57 PR(s) merged over the last 14 days (~1464 LoC/day)._
...
- **Velocity** is total LoC merged in the trailing 14 days divided by the window length in days. Idle days count against velocity: `20497` LoC across `57` PR(s) ⇒ `1464.1` LoC/day.
