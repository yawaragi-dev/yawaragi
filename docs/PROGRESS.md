...
_Snapshot generated 2026-07-19T10:51:43.282Z (UTC). Regenerate with `pnpm progress`._
...
_Based on 57 PR(s) merged over the last 14 days (~1693 LoC/day)._
...
- **Velocity** is total LoC merged in the trailing 14 days divided by the window length in days. Idle days count against velocity: `23699` LoC across `57` PR(s) ⇒ `1692.8` LoC/day.
