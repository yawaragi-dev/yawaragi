...
_Snapshot generated 2026-08-17T19:48:56.081Z (UTC). Regenerate with `pnpm progress`._
...
- **Optimistic:** 2026-09-11
- **Median:**     2026-09-23
- **Pessimistic:** 2026-10-29

_Based on 3 PR(s) merged over the last 14 days (~24 LoC/day)._
...
- **Velocity** is total LoC merged in the trailing 14 days divided by the window length in days. Idle days count against velocity: `331` LoC across `3` PR(s) ⇒ `23.6` LoC/day.
