...
_Snapshot generated 2026-06-21T18:37:23.531Z (UTC). Regenerate with `pnpm progress`._
...
| **M3** — Flagship surfaces | Phases 3–5 | 3 / 12 | 2568 / 10272 (25%) | `█████░░░░░░░░░░░░░░░` |
...
_Based on 12 PR(s) merged over the last 14 days (~1016 LoC/day)._

### M3 — Flagship surfaces (Phases 3–5)

Label scan (vision LLM), chat recommender (AI SDK tools + MCP), taste profile + cross-beverage map.

**Issues:** 3 closed / 12 total

**Weight (LoC of merged PRs):** 2568 closed / 10272 total — 25% done

`██████████░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░`

**ETA**

- **Optimistic:** 2026-06-27
- **Median:**     2026-06-29
- **Pessimistic:** 2026-07-07
...
- **Velocity** is total LoC merged in the trailing 14 days divided by the window length in days. Idle days count against velocity: `14219` LoC across `12` PR(s) ⇒ `1015.6` LoC/day.
