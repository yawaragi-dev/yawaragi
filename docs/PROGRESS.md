...
_Snapshot generated 2026-09-25T16:49:42.369Z (UTC). Regenerate with `pnpm progress`._
...
- **Optimistic:** 2026-09-27
- **Median:**     2026-09-28
- **Pessimistic:** 2026-09-30

_Based on 12 PR(s) merged over the last 14 days (~394 LoC/day)._
...
- **Velocity** is total LoC merged in the trailing 14 days divided by the window length in days. Idle days count against velocity: `5511` LoC across `12` PR(s) ⇒ `393.6` LoC/day.
