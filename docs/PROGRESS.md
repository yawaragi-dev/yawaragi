...
_Snapshot generated 2026-07-09T16:05:06.375Z (UTC). Regenerate with `pnpm progress`._
...
_Based on 34 PR(s) merged over the last 14 days (~1147 LoC/day)._
...
- **Velocity** is total LoC merged in the trailing 14 days divided by the window length in days. Idle days count against velocity: `16064` LoC across `34` PR(s) ⇒ `1147.4` LoC/day.
