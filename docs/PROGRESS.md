...
_Snapshot generated 2026-08-17T20:16:38.594Z (UTC). Regenerate with `pnpm progress`._
...
- **Optimistic:** 2026-08-29
- **Median:**     2026-09-03
- **Pessimistic:** 2026-09-20

_Based on 5 PR(s) merged over the last 14 days (~51 LoC/day)._
...
- **Velocity** is total LoC merged in the trailing 14 days divided by the window length in days. Idle days count against velocity: `716` LoC across `5` PR(s) ⇒ `51.1` LoC/day.
