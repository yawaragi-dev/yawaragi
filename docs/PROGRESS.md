...
_Snapshot generated 2026-07-08T06:46:22.138Z (UTC). Regenerate with `pnpm progress`._
...
_Based on 27 PR(s) merged over the last 14 days (~1057 LoC/day)._
...
- **Velocity** is total LoC merged in the trailing 14 days divided by the window length in days. Idle days count against velocity: `14793` LoC across `27` PR(s) ⇒ `1056.6` LoC/day.
