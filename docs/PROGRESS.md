...
_Snapshot generated 2026-08-18T05:30:24.964Z (UTC). Regenerate with `pnpm progress`._
...
- **Median:**     2026-08-26
- **Pessimistic:** 2026-09-03

_Based on 6 PR(s) merged over the last 14 days (~109 LoC/day)._
...
- **Velocity** is total LoC merged in the trailing 14 days divided by the window length in days. Idle days count against velocity: `1519` LoC across `6` PR(s) ⇒ `108.5` LoC/day.
