...
_Snapshot generated 2026-07-07T05:26:25.684Z (UTC). Regenerate with `pnpm progress`._
...
_Based on 13 PR(s) merged over the last 14 days (~579 LoC/day)._
...
- **Velocity** is total LoC merged in the trailing 14 days divided by the window length in days. Idle days count against velocity: `8103` LoC across `13` PR(s) ⇒ `578.8` LoC/day.
