...
_Snapshot generated 2026-09-23T20:47:44.614Z (UTC). Regenerate with `pnpm progress`._
...
- **Optimistic:** 2026-09-25
- **Median:**     2026-09-26
- **Pessimistic:** 2026-09-29

_Based on 10 PR(s) merged over the last 14 days (~324 LoC/day)._
...
- **Velocity** is total LoC merged in the trailing 14 days divided by the window length in days. Idle days count against velocity: `4532` LoC across `10` PR(s) ⇒ `323.7` LoC/day.
