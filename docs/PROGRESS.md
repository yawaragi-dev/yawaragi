...
_Snapshot generated 2026-07-18T19:04:45.971Z (UTC). Regenerate with `pnpm progress`._
...
- **Optimistic:** 2026-07-19
- **Median:**     2026-07-19
- **Pessimistic:** 2026-07-20

_Based on 55 PR(s) merged over the last 14 days (~1648 LoC/day)._
...
- **Velocity** is total LoC merged in the trailing 14 days divided by the window length in days. Idle days count against velocity: `23078` LoC across `55` PR(s) ⇒ `1648.4` LoC/day.
