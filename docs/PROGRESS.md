...
_Snapshot generated 2026-09-25T16:38:24.485Z (UTC). Regenerate with `pnpm progress`._
...
_Based on 11 PR(s) merged over the last 14 days (~324 LoC/day)._
...
- **Velocity** is total LoC merged in the trailing 14 days divided by the window length in days. Idle days count against velocity: `4538` LoC across `11` PR(s) ⇒ `324.1` LoC/day.
