...
_Snapshot generated 2026-06-01T20:54:55.233Z (UTC). Regenerate with `pnpm progress`._
...
_Based on 39 PR(s) merged over the last 14 days (~1392 LoC/day)._
...
- **Velocity** is total LoC merged in the trailing 14 days divided by the window length in days. Idle days count against velocity: `19488` LoC across `39` PR(s) ⇒ `1392.0` LoC/day.
