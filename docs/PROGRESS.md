...
_Snapshot generated 2026-07-14T06:50:05.705Z (UTC). Regenerate with `pnpm progress`._
...
_Based on 46 PR(s) merged over the last 14 days (~1542 LoC/day)._
...
- **Velocity** is total LoC merged in the trailing 14 days divided by the window length in days. Idle days count against velocity: `21594` LoC across `46` PR(s) ⇒ `1542.4` LoC/day.
