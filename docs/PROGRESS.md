...
_Snapshot generated 2026-06-02T06:31:28.650Z (UTC). Regenerate with `pnpm progress`._
...
_Based on 40 PR(s) merged over the last 14 days (~1395 LoC/day)._
...
- **Velocity** is total LoC merged in the trailing 14 days divided by the window length in days. Idle days count against velocity: `19533` LoC across `40` PR(s) ⇒ `1395.2` LoC/day.
