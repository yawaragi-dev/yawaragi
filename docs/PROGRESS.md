...
_Snapshot generated 2026-07-14T05:16:00.352Z (UTC). Regenerate with `pnpm progress`._
...
_Based on 44 PR(s) merged over the last 14 days (~1493 LoC/day)._
...
- **Velocity** is total LoC merged in the trailing 14 days divided by the window length in days. Idle days count against velocity: `20895` LoC across `44` PR(s) ⇒ `1492.5` LoC/day.
