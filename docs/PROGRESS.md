...
_Snapshot generated 2026-07-13T06:50:15.082Z (UTC). Regenerate with `pnpm progress`._
...
- **Optimistic:** 2026-07-14
- **Median:**     2026-07-14
- **Pessimistic:** 2026-07-15

_Based on 39 PR(s) merged over the last 14 days (~1256 LoC/day)._
...
- **Velocity** is total LoC merged in the trailing 14 days divided by the window length in days. Idle days count against velocity: `17589` LoC across `39` PR(s) ⇒ `1256.4` LoC/day.
