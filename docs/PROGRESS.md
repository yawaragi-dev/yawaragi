...
_Snapshot generated 2026-07-07T07:26:45.827Z (UTC). Regenerate with `pnpm progress`._
...
_Based on 18 PR(s) merged over the last 14 days (~740 LoC/day)._
...
- **Velocity** is total LoC merged in the trailing 14 days divided by the window length in days. Idle days count against velocity: `10366` LoC across `18` PR(s) ⇒ `740.4` LoC/day.
