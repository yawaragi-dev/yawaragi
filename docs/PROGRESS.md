...
_Snapshot generated 2026-07-16T16:18:10.290Z (UTC). Regenerate with `pnpm progress`._
...
_Based on 50 PR(s) merged over the last 14 days (~1595 LoC/day)._
...
- **Velocity** is total LoC merged in the trailing 14 days divided by the window length in days. Idle days count against velocity: `22332` LoC across `50` PR(s) ⇒ `1595.1` LoC/day.
