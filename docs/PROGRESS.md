...
_Snapshot generated 2026-07-16T07:05:30.902Z (UTC). Regenerate with `pnpm progress`._
...
_Based on 49 PR(s) merged over the last 14 days (~1586 LoC/day)._
...
- **Velocity** is total LoC merged in the trailing 14 days divided by the window length in days. Idle days count against velocity: `22208` LoC across `49` PR(s) ⇒ `1586.3` LoC/day.
