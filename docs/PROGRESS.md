...
_Snapshot generated 2026-06-21T21:02:02.407Z (UTC). Regenerate with `pnpm progress`._
...
_Based on 15 PR(s) merged over the last 14 days (~1192 LoC/day)._
...
- **Velocity** is total LoC merged in the trailing 14 days divided by the window length in days. Idle days count against velocity: `16684` LoC across `15` PR(s) ⇒ `1191.7` LoC/day.
