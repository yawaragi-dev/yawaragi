...
_Snapshot generated 2026-06-09T20:10:38.931Z (UTC). Regenerate with `pnpm progress`._
...
_Based on 29 PR(s) merged over the last 14 days (~1283 LoC/day)._
...
- **Velocity** is total LoC merged in the trailing 14 days divided by the window length in days. Idle days count against velocity: `17955` LoC across `29` PR(s) ⇒ `1282.5` LoC/day.
