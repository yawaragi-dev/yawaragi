...
_Snapshot generated 2026-07-16T16:25:03.114Z (UTC). Regenerate with `pnpm progress`._
...
_Based on 53 PR(s) merged over the last 14 days (~1638 LoC/day)._
...
- **Velocity** is total LoC merged in the trailing 14 days divided by the window length in days. Idle days count against velocity: `22932` LoC across `53` PR(s) ⇒ `1638.0` LoC/day.
