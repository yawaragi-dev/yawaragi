...
_Snapshot generated 2026-07-09T05:50:25.981Z (UTC). Regenerate with `pnpm progress`._
...
_Based on 33 PR(s) merged over the last 14 days (~1137 LoC/day)._
...
- **Velocity** is total LoC merged in the trailing 14 days divided by the window length in days. Idle days count against velocity: `15914` LoC across `33` PR(s) ⇒ `1136.7` LoC/day.
