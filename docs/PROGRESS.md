...
_Snapshot generated 2026-07-07T07:03:37.188Z (UTC). Regenerate with `pnpm progress`._
...
_Based on 17 PR(s) merged over the last 14 days (~740 LoC/day)._
...
- **Velocity** is total LoC merged in the trailing 14 days divided by the window length in days. Idle days count against velocity: `10356` LoC across `17` PR(s) ⇒ `739.7` LoC/day.
