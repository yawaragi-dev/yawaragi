...
_Snapshot generated 2026-07-13T06:53:59.445Z (UTC). Regenerate with `pnpm progress`._
...
_Based on 40 PR(s) merged over the last 14 days (~1319 LoC/day)._
...
- **Velocity** is total LoC merged in the trailing 14 days divided by the window length in days. Idle days count against velocity: `18460` LoC across `40` PR(s) ⇒ `1318.6` LoC/day.
