...
_Snapshot generated 2026-06-04T05:19:33.897Z (UTC). Regenerate with `pnpm progress`._
...
- **Optimistic:** 2026-06-05
- **Median:**     2026-06-05
- **Pessimistic:** 2026-06-06

_Based on 42 PR(s) merged over the last 14 days (~1434 LoC/day)._
...
- **Velocity** is total LoC merged in the trailing 14 days divided by the window length in days. Idle days count against velocity: `20078` LoC across `42` PR(s) ⇒ `1434.1` LoC/day.
