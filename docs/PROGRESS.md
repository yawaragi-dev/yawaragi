...
_Snapshot generated 2026-07-09T16:13:23.005Z (UTC). Regenerate with `pnpm progress`._
...
_Based on 35 PR(s) merged over the last 14 days (~1212 LoC/day)._
...
- **Velocity** is total LoC merged in the trailing 14 days divided by the window length in days. Idle days count against velocity: `16973` LoC across `35` PR(s) ⇒ `1212.4` LoC/day.
