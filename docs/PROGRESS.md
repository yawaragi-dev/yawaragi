...
_Snapshot generated 2026-07-07T18:47:16.932Z (UTC). Regenerate with `pnpm progress`._
...
_Based on 21 PR(s) merged over the last 14 days (~860 LoC/day)._
...
- **Velocity** is total LoC merged in the trailing 14 days divided by the window length in days. Idle days count against velocity: `12045` LoC across `21` PR(s) ⇒ `860.4` LoC/day.
