...
_Snapshot generated 2026-07-06T20:14:48.304Z (UTC). Regenerate with `pnpm progress`._
...
_Based on 9 PR(s) merged over the last 14 days (~560 LoC/day)._
...
- **Velocity** is total LoC merged in the trailing 14 days divided by the window length in days. Idle days count against velocity: `7842` LoC across `9` PR(s) ⇒ `560.1` LoC/day.
