...
_Snapshot generated 2026-07-15T04:51:51.404Z (UTC). Regenerate with `pnpm progress`._
...
- **Optimistic:** 2026-07-16
- **Median:**     2026-07-16
- **Pessimistic:** 2026-07-17

_Based on 49 PR(s) merged over the last 14 days (~1605 LoC/day)._
...
- **Velocity** is total LoC merged in the trailing 14 days divided by the window length in days. Idle days count against velocity: `22476` LoC across `49` PR(s) ⇒ `1605.4` LoC/day.
