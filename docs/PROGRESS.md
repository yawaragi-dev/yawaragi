...
_Snapshot generated 2026-08-18T05:36:09.108Z (UTC). Regenerate with `pnpm progress`._
...
- **Median:**     2026-08-26
- **Pessimistic:** 2026-09-02

_Based on 7 PR(s) merged over the last 14 days (~115 LoC/day)._
...
- **Velocity** is total LoC merged in the trailing 14 days divided by the window length in days. Idle days count against velocity: `1604` LoC across `7` PR(s) ⇒ `114.6` LoC/day.
