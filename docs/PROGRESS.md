...
_Snapshot generated 2026-07-16T16:18:45.381Z (UTC). Regenerate with `pnpm progress`._
...
_Based on 51 PR(s) merged over the last 14 days (~1607 LoC/day)._
...
- **Velocity** is total LoC merged in the trailing 14 days divided by the window length in days. Idle days count against velocity: `22503` LoC across `51` PR(s) ⇒ `1607.4` LoC/day.
