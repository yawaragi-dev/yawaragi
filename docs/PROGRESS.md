...
_Snapshot generated 2026-08-17T19:41:44.784Z (UTC). Regenerate with `pnpm progress`._
...
- **Optimistic:** 2027-06-21
- **Median:**     2027-11-21
- **Pessimistic:** 2029-02-24

_Based on 2 PR(s) merged over the last 14 days (~2 LoC/day)._
...
- **Velocity** is total LoC merged in the trailing 14 days divided by the window length in days. Idle days count against velocity: `26` LoC across `2` PR(s) ⇒ `1.9` LoC/day.
