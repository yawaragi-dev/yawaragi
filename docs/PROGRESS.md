...
_Snapshot generated 2026-07-09T16:14:01.562Z (UTC). Regenerate with `pnpm progress`._
...
_Based on 36 PR(s) merged over the last 14 days (~1216 LoC/day)._
...
- **Velocity** is total LoC merged in the trailing 14 days divided by the window length in days. Idle days count against velocity: `17026` LoC across `36` PR(s) ⇒ `1216.1` LoC/day.
