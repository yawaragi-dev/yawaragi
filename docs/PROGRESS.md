...
_Snapshot generated 2026-07-08T05:26:02.111Z (UTC). Regenerate with `pnpm progress`._
...
_Based on 26 PR(s) merged over the last 14 days (~1012 LoC/day)._
...
- **Velocity** is total LoC merged in the trailing 14 days divided by the window length in days. Idle days count against velocity: `14163` LoC across `26` PR(s) ⇒ `1011.6` LoC/day.
