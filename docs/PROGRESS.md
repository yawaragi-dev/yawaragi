...
_Snapshot generated 2026-07-07T20:32:07.737Z (UTC). Regenerate with `pnpm progress`._
...
_Based on 25 PR(s) merged over the last 14 days (~956 LoC/day)._
...
- **Velocity** is total LoC merged in the trailing 14 days divided by the window length in days. Idle days count against velocity: `13390` LoC across `25` PR(s) ⇒ `956.4` LoC/day.
