...
_Snapshot generated 2026-07-06T17:10:50.571Z (UTC). Regenerate with `pnpm progress`._
...
_Based on 8 PR(s) merged over the last 14 days (~495 LoC/day)._
...
- **Velocity** is total LoC merged in the trailing 14 days divided by the window length in days. Idle days count against velocity: `6930` LoC across `8` PR(s) ⇒ `495.0` LoC/day.
