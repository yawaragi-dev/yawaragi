...
_Snapshot generated 2026-07-07T05:23:08.419Z (UTC). Regenerate with `pnpm progress`._
...
_Based on 11 PR(s) merged over the last 14 days (~571 LoC/day)._
...
- **Velocity** is total LoC merged in the trailing 14 days divided by the window length in days. Idle days count against velocity: `7996` LoC across `11` PR(s) ⇒ `571.1` LoC/day.
