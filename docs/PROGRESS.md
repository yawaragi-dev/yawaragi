...
_Snapshot generated 2026-08-17T16:20:38.705Z (UTC). Regenerate with `pnpm progress`._
...
- **Optimistic:** 2027-12-30
- **Median:**     2028-09-04
- **Pessimistic:** 2030-09-23

_Based on 1 PR(s) merged over the last 14 days (~1 LoC/day)._
...
- **Velocity** is total LoC merged in the trailing 14 days divided by the window length in days. Idle days count against velocity: `16` LoC across `1` PR(s) ⇒ `1.1` LoC/day.
