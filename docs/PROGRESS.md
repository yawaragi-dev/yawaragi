...
_Snapshot generated 2026-07-07T05:44:34.643Z (UTC). Regenerate with `pnpm progress`._
...
_Based on 16 PR(s) merged over the last 14 days (~710 LoC/day)._
...
- **Velocity** is total LoC merged in the trailing 14 days divided by the window length in days. Idle days count against velocity: `9935` LoC across `16` PR(s) ⇒ `709.6` LoC/day.
