...
_Snapshot generated 2026-06-02T06:35:46.822Z (UTC). Regenerate with `pnpm progress`._
...
_Based on 41 PR(s) merged over the last 14 days (~1408 LoC/day)._
...
- **Velocity** is total LoC merged in the trailing 14 days divided by the window length in days. Idle days count against velocity: `19714` LoC across `41` PR(s) ⇒ `1408.1` LoC/day.
