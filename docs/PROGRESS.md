...
_Snapshot generated 2026-07-13T06:33:05.990Z (UTC). Regenerate with `pnpm progress`._
...
_Based on 38 PR(s) merged over the last 14 days (~1242 LoC/day)._
...
- **Velocity** is total LoC merged in the trailing 14 days divided by the window length in days. Idle days count against velocity: `17381` LoC across `38` PR(s) ⇒ `1241.5` LoC/day.
