...
_Snapshot generated 2026-08-17T20:07:04.968Z (UTC). Regenerate with `pnpm progress`._
...
- **Optimistic:** 2026-09-09
- **Median:**     2026-09-20
- **Pessimistic:** 2026-10-23

_Based on 4 PR(s) merged over the last 14 days (~26 LoC/day)._
...
- **Velocity** is total LoC merged in the trailing 14 days divided by the window length in days. Idle days count against velocity: `359` LoC across `4` PR(s) ⇒ `25.6` LoC/day.
