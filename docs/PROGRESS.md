...
_Snapshot generated 2026-06-10T22:09:01.370Z (UTC). Regenerate with `pnpm progress`._
...
_Based on 31 PR(s) merged over the last 14 days (~1575 LoC/day)._
...
- **Velocity** is total LoC merged in the trailing 14 days divided by the window length in days. Idle days count against velocity: `22053` LoC across `31` PR(s) ⇒ `1575.2` LoC/day.
