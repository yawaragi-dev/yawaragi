...
_Snapshot generated 2026-07-18T20:09:38.695Z (UTC). Regenerate with `pnpm progress`._
...
_Based on 56 PR(s) merged over the last 14 days (~1680 LoC/day)._
...
- **Velocity** is total LoC merged in the trailing 14 days divided by the window length in days. Idle days count against velocity: `23513` LoC across `56` PR(s) ⇒ `1679.5` LoC/day.
