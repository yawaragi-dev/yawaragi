...
_Snapshot generated 2026-09-21T06:16:07.051Z (UTC). Regenerate with `pnpm progress`._
...
- **Optimistic:** 2026-11-16
- **Median:**     2026-12-14
- **Pessimistic:** 2027-03-08

_Based on 2 PR(s) merged over the last 14 days (~10 LoC/day)._
...
- **Velocity** is total LoC merged in the trailing 14 days divided by the window length in days. Idle days count against velocity: `143` LoC across `2` PR(s) ⇒ `10.2` LoC/day.
