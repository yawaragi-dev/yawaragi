...
_Snapshot generated 2026-06-05T12:33:09.430Z (UTC). Regenerate with `pnpm progress`._
...
- **Optimistic:** 2026-06-06
- **Median:**     2026-06-06
- **Pessimistic:** 2026-06-07

_Based on 45 PR(s) merged over the last 14 days (~1505 LoC/day)._
...
- **Velocity** is total LoC merged in the trailing 14 days divided by the window length in days. Idle days count against velocity: `21064` LoC across `45` PR(s) ⇒ `1504.6` LoC/day.
