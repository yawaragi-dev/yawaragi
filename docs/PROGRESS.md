...
_Snapshot generated 2026-07-09T05:48:17.421Z (UTC). Regenerate with `pnpm progress`._
...
_Based on 32 PR(s) merged over the last 14 days (~1128 LoC/day)._
...
- **Velocity** is total LoC merged in the trailing 14 days divided by the window length in days. Idle days count against velocity: `15789` LoC across `32` PR(s) ⇒ `1127.8` LoC/day.
