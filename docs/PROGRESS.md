...
_Snapshot generated 2026-06-04T07:22:36.595Z (UTC). Regenerate with `pnpm progress`._
...
_Based on 43 PR(s) merged over the last 14 days (~1472 LoC/day)._
...
- **Velocity** is total LoC merged in the trailing 14 days divided by the window length in days. Idle days count against velocity: `20610` LoC across `43` PR(s) ⇒ `1472.1` LoC/day.
