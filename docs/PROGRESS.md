...
_Snapshot generated 2026-07-19T20:30:50.039Z (UTC). Regenerate with `pnpm progress`._
...
_Based on 58 PR(s) merged over the last 14 days (~1482 LoC/day)._
...
- **Velocity** is total LoC merged in the trailing 14 days divided by the window length in days. Idle days count against velocity: `20746` LoC across `58` PR(s) ⇒ `1481.9` LoC/day.
