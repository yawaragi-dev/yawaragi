...
_Snapshot generated 2026-05-31T18:28:04.928Z (UTC). Regenerate with `pnpm progress`._

## TL;DR

| Milestone | Phases | Closed / Total issues | Closed / Total LoC weight | Bar |
| --- | --- | --- | --- | --- |
| **M1** — Compliance & i18n foundation | Phase 0 | 4 / 5 | 5408 / 6760 (80%) | `████████████████░░░░` |
| **M2** — Data foundation | Phase 2 | 8 / 12 | 11543 / 16951 (68%) | `██████████████░░░░░░` |
...
**Weight (LoC of merged PRs):** 5408 closed / 6760 total — 80% done
...
_Based on 31 PR(s) merged over the last 14 days (~1086 LoC/day)._
...
**Issues:** 8 closed / 12 total

**Weight (LoC of merged PRs):** 11543 closed / 16951 total — 68% done

`███████████████████████████░░░░░░░░░░░░░`

**ETA**

- **Optimistic:** 2026-06-04
- **Median:**     2026-06-05
- **Pessimistic:** 2026-06-10
...
- **Velocity** is total LoC merged in the trailing 14 days divided by the window length in days. Idle days count against velocity: `15210` LoC across `31` PR(s) ⇒ `1086.4` LoC/day.
