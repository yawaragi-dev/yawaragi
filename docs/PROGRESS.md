...
_Snapshot generated 2026-07-13T06:57:02.602Z (UTC). Regenerate with `pnpm progress`._
...
_Based on 41 PR(s) merged over the last 14 days (~1419 LoC/day)._
...
- **Velocity** is total LoC merged in the trailing 14 days divided by the window length in days. Idle days count against velocity: `19870` LoC across `41` PR(s) ⇒ `1419.3` LoC/day.
