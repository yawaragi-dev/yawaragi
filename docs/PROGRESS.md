...
_Snapshot generated 2026-07-14T06:10:54.144Z (UTC). Regenerate with `pnpm progress`._
...
_Based on 45 PR(s) merged over the last 14 days (~1518 LoC/day)._
...
- **Velocity** is total LoC merged in the trailing 14 days divided by the window length in days. Idle days count against velocity: `21258` LoC across `45` PR(s) ⇒ `1518.4` LoC/day.
