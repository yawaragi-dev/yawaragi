...
_Snapshot generated 2026-06-10T18:39:51.604Z (UTC). Regenerate with `pnpm progress`._
...
- **Optimistic:** 2026-06-11
- **Median:**     2026-06-11
- **Pessimistic:** 2026-06-12

_Based on 30 PR(s) merged over the last 14 days (~1552 LoC/day)._
...
- **Velocity** is total LoC merged in the trailing 14 days divided by the window length in days. Idle days count against velocity: `21729` LoC across `30` PR(s) ⇒ `1552.1` LoC/day.
