...
_Snapshot generated 2026-08-18T05:51:05.403Z (UTC). Regenerate with `pnpm progress`._
...
- **Optimistic:** 2026-08-22
- **Median:**     2026-08-24
- **Pessimistic:** 2026-08-30

_Based on 9 PR(s) merged over the last 14 days (~155 LoC/day)._
...
- **Velocity** is total LoC merged in the trailing 14 days divided by the window length in days. Idle days count against velocity: `2172` LoC across `9` PR(s) ⇒ `155.1` LoC/day.
