...
_Snapshot generated 2026-06-21T19:57:42.494Z (UTC). Regenerate with `pnpm progress`._
...
| **M3** — Flagship surfaces | Phases 3–5 | 4 / 12 | 3424 / 10272 (33%) | `███████░░░░░░░░░░░░░` |
...
- **Optimistic:** 2026-06-22
- **Median:**     2026-06-22
- **Pessimistic:** 2026-06-23

_Based on 13 PR(s) merged over the last 14 days (~1028 LoC/day)._

### M3 — Flagship surfaces (Phases 3–5)

Label scan (vision LLM), chat recommender (AI SDK tools + MCP), taste profile + cross-beverage map.

**Issues:** 4 closed / 12 total

**Weight (LoC of merged PRs):** 3424 closed / 10272 total — 33% done

`█████████████░░░░░░░░░░░░░░░░░░░░░░░░░░░`

**ETA**

- **Optimistic:** 2026-06-26
- **Median:**     2026-06-28
- **Pessimistic:** 2026-07-05
...
- **Velocity** is total LoC merged in the trailing 14 days divided by the window length in days. Idle days count against velocity: `14391` LoC across `13` PR(s) ⇒ `1027.9` LoC/day.
