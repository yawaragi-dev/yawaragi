...
_Snapshot generated 2026-07-16T06:46:46.642Z (UTC). Regenerate with `pnpm progress`._
...
_Based on 48 PR(s) merged over the last 14 days (~1582 LoC/day)._
...
- **Velocity** is total LoC merged in the trailing 14 days divided by the window length in days. Idle days count against velocity: `22148` LoC across `48` PR(s) ⇒ `1582.0` LoC/day.
