...
_Snapshot generated 2026-07-16T16:21:32.693Z (UTC). Regenerate with `pnpm progress`._
...
- **Optimistic:** 2026-07-17
- **Median:**     2026-07-17
- **Pessimistic:** 2026-07-18

_Based on 52 PR(s) merged over the last 14 days (~1631 LoC/day)._
...
- **Velocity** is total LoC merged in the trailing 14 days divided by the window length in days. Idle days count against velocity: `22833` LoC across `52` PR(s) ⇒ `1630.9` LoC/day.
