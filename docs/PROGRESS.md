...
_Snapshot generated 2026-07-19T20:06:35.070Z (UTC). Regenerate with `pnpm progress`._
...
_Based on 56 PR(s) merged over the last 14 days (~1440 LoC/day)._
...
- **Velocity** is total LoC merged in the trailing 14 days divided by the window length in days. Idle days count against velocity: `20159` LoC across `56` PR(s) ⇒ `1439.9` LoC/day.
