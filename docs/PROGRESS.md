...
_Snapshot generated 2026-07-14T20:23:37.882Z (UTC). Regenerate with `pnpm progress`._
...
_Based on 48 PR(s) merged over the last 14 days (~1598 LoC/day)._
...
- **Velocity** is total LoC merged in the trailing 14 days divided by the window length in days. Idle days count against velocity: `22377` LoC across `48` PR(s) ⇒ `1598.4` LoC/day.
