...
_Snapshot generated 2026-07-07T05:40:10.414Z (UTC). Regenerate with `pnpm progress`._
...
_Based on 14 PR(s) merged over the last 14 days (~634 LoC/day)._
...
- **Velocity** is total LoC merged in the trailing 14 days divided by the window length in days. Idle days count against velocity: `8878` LoC across `14` PR(s) ⇒ `634.1` LoC/day.
