...
_Snapshot generated 2026-06-21T20:56:39.453Z (UTC). Regenerate with `pnpm progress`._
...
| **M3** — Flagship surfaces | Phases 3–5 | 5 / 12 | 4280 / 10272 (42%) | `████████░░░░░░░░░░░░` |
...
_Based on 14 PR(s) merged over the last 14 days (~1151 LoC/day)._

### M3 — Flagship surfaces (Phases 3–5)

Label scan (vision LLM), chat recommender (AI SDK tools + MCP), taste profile + cross-beverage map.

**Issues:** 5 closed / 12 total

**Weight (LoC of merged PRs):** 4280 closed / 10272 total — 42% done
...
- **Velocity** is total LoC merged in the trailing 14 days divided by the window length in days. Idle days count against velocity: `16109` LoC across `14` PR(s) ⇒ `1150.6` LoC/day.
