...
_Snapshot generated 2026-07-07T05:40:42.966Z (UTC). Regenerate with `pnpm progress`._
...
_Based on 15 PR(s) merged over the last 14 days (~646 LoC/day)._
...
- **Velocity** is total LoC merged in the trailing 14 days divided by the window length in days. Idle days count against velocity: `9049` LoC across `15` PR(s) ⇒ `646.4` LoC/day.
