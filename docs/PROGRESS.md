...
_Snapshot generated 2026-07-08T21:29:46.870Z (UTC). Regenerate with `pnpm progress`._
...
_Based on 30 PR(s) merged over the last 14 days (~1096 LoC/day)._
...
- **Velocity** is total LoC merged in the trailing 14 days divided by the window length in days. Idle days count against velocity: `15348` LoC across `30` PR(s) ⇒ `1096.3` LoC/day.
