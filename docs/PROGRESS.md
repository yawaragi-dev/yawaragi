...
_Snapshot generated 2026-07-13T04:59:15.051Z (UTC). Regenerate with `pnpm progress`._
...
_Based on 37 PR(s) merged over the last 14 days (~1232 LoC/day)._
...
- **Velocity** is total LoC merged in the trailing 14 days divided by the window length in days. Idle days count against velocity: `17247` LoC across `37` PR(s) ⇒ `1231.9` LoC/day.
