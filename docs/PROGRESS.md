...
_Snapshot generated 2026-07-07T20:05:54.612Z (UTC). Regenerate with `pnpm progress`._
...
_Based on 23 PR(s) merged over the last 14 days (~889 LoC/day)._
...
- **Velocity** is total LoC merged in the trailing 14 days divided by the window length in days. Idle days count against velocity: `12440` LoC across `23` PR(s) ⇒ `888.6` LoC/day.
