...
_Snapshot generated 2026-06-10 from GitHub Issues + merged PRs. Regenerate with `pnpm progress`. Detail: [docs/PROGRESS.md](./docs/PROGRESS.md)._

| Milestone | Progress | Issues | ETA (median) |
| --- | --- | --- | --- |
| **M1 (Phase 0) — Compliance & i18n foundation** | `████████████████████` 100% | 5 / 5 | done |
| **M2 (Phase 2) — Data foundation** | `███████████████████░` 94% | 11 / 12 | 2026-06-11 |
| **M3 (Phases 3–5) — Flagship surfaces** | `████████████░░░░░░░░` 60% | 3 / 5 | 2026-06-12 |
